...
## Case Stats
Use this exact Resource Analysis format (no bullets, no per-method breakdowns):
Resource Analysis
Time Complexity
<Descriptor e.g. INSTANT / LINEAR / FAST>
O(...) - <one-sentence explanation tied to N or input size>
INPUT SIZE (N) ->
Space Complexity
<Descriptor e.g. INSTANT / LINEAR / FAST>
O(...) - <one-sentence explanation tied to N or input size>
